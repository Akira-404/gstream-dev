...
// source lement:src pad
// filter element:src pad & sink pad
// sink element:sink pad
// demuxer:nxsource pad & 1xsink pad
...
static void pad_aded_handler(GstElement *src, GstPad *pad, CustomData *data);
...
int main(int argc, char *argv[])
{
    ...
    // 使用g_signal_connect()方法把“pad-added”信号和我们的源（uridecodebin）联系了起来，并且注册了一个回调函数。
